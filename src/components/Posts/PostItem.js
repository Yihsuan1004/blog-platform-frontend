...
const PostItem = props =>{
   return <div className="flex items-center justify-between w-full mb-8">
            <div>
                <div className="flex items-center mt-2">
                    <div className="text-left pr-4">
                        <h3 className="text-2xl font-semibold">What is Micro Frontend?</h3>
                        <p className="text-m text-gray-600">You may have heard from your backend team thatYou may have heard from your backend team that </p>
